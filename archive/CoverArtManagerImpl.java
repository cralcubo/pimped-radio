...
public class CoverArtManagerImpl implements CoverArtManager{
	private final static Logger log = LoggerFactory.getLogger(CoverArtManagerImpl.class);
	...
	public CoverArtManagerImpl() {
		this(new MBAlbumFinder(MAXALBUMS_FETCHED), new CoverArchiveFinder(), new AmazonCoverFinder(), new FacebookRadioStationFinder());
	}

	CoverArtManagerImpl(AlbumFindable albumFinder, CoverArtFindable coverArchiveFinder, CoverArtFindable amazonFinder, RadioStationFindable radioFinder) {
