...
public class AmazonConnectionUtil {
	private final static Logger log = LoggerFactory.getLogger(AmazonConnectionUtil.class);
	...
	private final static String SEARCHQUERY_TEMPLATE = 
			  "AWSAccessKeyId=%s"
			+ "&Artist='%s'"
			+ "&AssociateTag=%s"
	 ...
	 * @return
	 */
	public static String generateSearchByKeywordRequestUrl(String keyword) {
	 ...
	 * @return
	 */
	public static String generateSearchByAlbumRequestUrl(Album album) {
