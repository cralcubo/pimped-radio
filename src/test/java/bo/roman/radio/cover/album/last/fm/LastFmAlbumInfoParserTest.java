...
public class LastFmAlbumInfoParserTest {
	private final static String AI_NEVERMIND = LastFmTestsUtils.RESOURCES_PATH + "albumInfo_Nevermind.json";
	
	private Album oneTrackOnly;

	@Before
	public void setUp() throws IOException {
		oneTrackOnly = LastFmParser.parseAlbumInfo(LastFmTestsUtils.getJsonResponse(AI_NEVERMIND));
	}
	...
	public void testParseSong() {
		Assert.assertNull(oneTrackOnly.getSongName());
	}
